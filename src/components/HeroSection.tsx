...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden transform-gpu" style={{ contain: "layout paint style" }}>
      {/* Animated orbs */}
      <motion.div
      ...
      <motion.div className="relative z-10 max-w-7xl mx-auto px-6 text-center" style={{ willChange: "transform, opacity" }}>
        <motion.div
